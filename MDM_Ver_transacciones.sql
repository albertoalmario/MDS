--ver listado de bach tags creados
...
AND B.EnterDTM >= '2017-10-30 00:00:00'
...
--Tabla de transacciones de MDM
SELECT COUNT(*) FROM mdm.tblTransaction WHERE EnterDTM >= '2017-10-29 00:00:00'